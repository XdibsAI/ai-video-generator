...
# #                     story_generator.api_key = OPENROUTER_API_KEY  # TEMPORARILY COMMENTED  # TEMPORARILY COMMENTED
#                     st.sidebar.success("✅ API Key Loaded")  # TEMPORARILY COMMENTED
                else:
                    st.sidebar.warning("⚠️ API Key not configured")
        
#                 except ImportError as e:  # REMOVED: problematic except
#                     st.error(f"❌ Import Error: {e}")  # REMOVED: problematic error
